...
Necesitas tener instalado **Node.js** y **npm** antes de empezar.
...
Crea un archivo `.env` en esa carpeta con tu cadena de conexión a MongoDB:
...
Proyecto universitario desarrollado para el curso de **Introducción al Software** en la Universidad Francisco Marroquín (UFM), Guatemala.

---

> *"Sin filas. Sin efectivo. Solo pídelo."*